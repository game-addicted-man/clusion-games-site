...
const translations = {
  ko: {
    ...
    orangeWikiStatus: '준비중', orangeWikiEyebrow: 'PROJECT 02', orangeWikiLead: '이름 없는 역에서 시작되는 새로운 미스터리.',
  ...
  en: {
    ...
    orangeWikiStatus: 'IN PREPARATION', orangeWikiEyebrow: 'PROJECT 02', orangeWikiLead: 'A new mystery begins at a station without a name.',
